[index.html2.html](https://github.com/user-attachments/files/23938750/index.html2.html)
<!DOCTYPE html>
<html lang="id">
<head>
    <meta charset="UTF-8">
...
<body>
    ...
    <p>Klik pada marker provinsi untuk melihat informasi detail.</p>
    <div id="map"></div>
    <div id="info">
    ...
    <script>
        ...
        // Data provinsi Sumatra dengan koordinat perkiraan (untuk demo; gunakan GeoJSON untuk akurasi penuh)
        const provinces = {
            aceh: {
                name: "Aceh",
                coords: [4.6951, 96.7494],
                religion: "Islam (98%)",
                population: "5,3 juta (2023)",
